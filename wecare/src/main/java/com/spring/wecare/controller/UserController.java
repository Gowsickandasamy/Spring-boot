...
import com.spring.wecare.models.ComplaintModel;
import com.spring.wecare.models.PasswordModel;
import com.spring.wecare.models.UserModel;
  ...
  private static final String SUCCESS_MESSAGE = "successMessage";
	...
	public String updateUserProfile(Model model, @ModelAttribute UserModel userModel,
		...
		if (!userDetails.getUsername().equals(userModel.getEmail())) {
			...
			redirectAttributes.addFlashAttribute("successMessage", "Profile Updated Successfully. Please Login again !");
