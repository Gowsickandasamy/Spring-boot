package com.spring.wecare.controller;
...
import com.spring.wecare.exception.WeCareException;
import com.spring.wecare.models.AdminModel;
import com.spring.wecare.models.JurisdictionModel;
import com.spring.wecare.models.OfficerModel;
import com.spring.wecare.models.PasswordModel;
import com.spring.wecare.service.AdminService;
import com.spring.wecare.service.ComplaintService;
import com.spring.wecare.service.JurisdictionService;
import com.spring.wecare.service.OfficerService;
import com.spring.wecare.service.UserService;
...
public class AdminController {
	...
	public String updateJurisdiction(Model model, @ModelAttribute JurisdictionModel juryModel, RedirectAttributes redirectAttributes) {
		...
		if (Objects.nonNull(jury)) {
			model.addAttribute("newJurisdiction", juryModel);
			model.addAttribute("jurisdictions", juryService.getAllJurisdictions());
	...
	public String showAddJurisdictionForm(Model model, @AuthenticationPrincipal UserDetails userDetails) {
		adminDetails(model, userDetails);
		model.addAttribute("newJurisdiction", new JurisdictionModel());
	...
	public String updateOfficer(@ModelAttribute OfficerModel officer, @RequestParam Integer juryId, RedirectAttributes redirectAttributes) {
		...
		if ((Objects.nonNull(officerByEmail) && officerByEmail.getOfficerId() != (existingOfficer.getOfficerId()))
			...
			redirectAttributes.addFlashAttribute("errorMessage", "Officer with the Email Id or Phone already exists!");
